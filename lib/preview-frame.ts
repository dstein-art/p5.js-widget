...
function p5PlayUrl(version) {
  return "//p5play.org/v3/p5play.js";
}
function planckUrl(version) {
  return "//p5play.org/v3/planck.min.js";
}
...
function startSketch(sketch: string, p5version: string, maxRunTime: number,
  ...
  loadScripts([
    p5url(p5version) , p5SoundUrl(p5version),planckUrl(p5version),p5PlayUrl(p5version),
  ], () => {
